...
from .model.simple_cnn_lstm import SimpleCNN_LSTM  # your simple CNN + LSTM
...
def main(random_selection=False, headless=True, short_exec=False):
    ...
    model = load_policy(
        "./omnigibson/baseline/IL/checkpoint/best_lstm_policy_mobile_new_v3_16.pth",
        num_actions=6,
        device=device
    )
    ...
    for ep in range(total_episodes):
        ...
        with open("C:/Users/Admin/Desktop/OmniGibson-Rearrange/evaluate_mobilev3_16.txt", 'a') as f:
...
if __name__ == "__main__":
    ...
    with open("C:/Users/Admin/Desktop/OmniGibson-Rearrange/evaluate_mobilev3_16.txt", 'r') as f:
        for line in f:
            parts = line.split(':', 1)
            if len(parts[0]) > 0:
...
#     with open("C:/Users/Admin/Desktop/OmniGibson-Rearrange/evaluate_mobilev3_16_train.txt", 'r') as f:
#         for line in f:
#             parts = line.split(':', 1)
#             if len(parts[0]) > 0:
#                 invalid_scene = parts[0].replace("_target.json", "")
