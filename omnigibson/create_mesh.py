...
current_path = os.getcwd() # Omnigibson-Rearrange
# 输入 JSON 文件所在的文件夹路径
input_folder = os.path.join(current_path, 'omnigibson/data/3d_front/3D-FRONT')
# USD 输出的基础文件夹（后续会根据 JSON 内 uid 创建子文件夹）
output_base = os.path.join(current_path, 'omnigibson/data/3d_front/mesh')
