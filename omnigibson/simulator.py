...
m.SCENE_MARGIN = 10.0
m.INITIAL_SCENE_PRIM_Z_OFFSET = 0.0
...
def _launch_simulator(*args, **kwargs):
    ...
    class Simulator(lazy.omni.isaac.core.simulation_context.SimulationContext, Serializable):
        ...
        def _set_physics_engine_settings(self):
            ...
            # 设置up-axis为y，并设置重力方向为y轴负向
            stage = lazy.omni.isaac.core.utils.stage.get_current_stage()
            lazy.pxr.UsdGeom.SetStageUpAxis(stage, lazy.pxr.UsdGeom.Tokens.y)
        ...
        def import_scene_rearrange(self, scene, env_id):
            """
