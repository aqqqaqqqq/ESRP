...
def extract_and_filter_logs(folder_path):
    ...
    with open("/home/pilab/Desktop/wq/rearrange/save_models/train_sampled_new_new.txt", 'r') as f:
...
# Example usage:
folder_path = "/home/pilab/Desktop/wq/rearrange/model_nolstm"  # Your folder path
