...
MODEL_PATH = '....../rearrange/save_models/3000'
NEW_LOG = '....../rearrange/save_models/ppo_lstm_new_val.log' 
SPLIT = [(0, 200)]
...
def main(random_selection=False, headless=False, short_exec=False, quickstart=False):
    ...
    with open('......./omnigibson/data/3d_front/train_sampled_new.txt', 'r') as f:
        for line in f:
