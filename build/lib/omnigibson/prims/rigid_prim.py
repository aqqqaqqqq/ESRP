...
from omnigibson.prims.geom_prim import CollisionGeomPrim, VisualGeomPrim, CollisionVisualGeomPrim
...
class RigidPrim(XFormPrim):
    ...
    def _post_load(self):
        ...
        # check if it's an object from 3d_front
        self._3d_front = "dataset" in self._load_config and self._load_config["dataset"] == "3d_front"
        # run super first
        super()._post_load()
    ...
    def update_meshes(self):
        ...
        for prim in prims_to_check:
            ...
            if mesh_type in GEOM_TYPES:
                ...
                # if it's a mesh of object from 3d front, then apply collision attribute to it.
                if self._3d_front:
                ...
                if is_collision:
                    # if it's a mesh of object from 3d front, then use CollisionVisualGeomPrim (both visible and collidable)
                    if self._3d_front:
                        mesh = CollisionVisualGeomPrim(**mesh_kwargs)
                    else:
