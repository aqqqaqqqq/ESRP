...
class ThreeD_FRONTObject(StatefulObject):
    """
    3d_front objects
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._usd_path =gm.ThreeD_FRONT_DATASET_PATH + self._usd_path
        self._encrypted = encrypted
        self.is_to_rearrange = is_to_rearrange
        self.mesh_type =mesh_type
        self.floor_xyz = floor_xyz
        self.target_bbox = target_bbox

        load_config = dict() if load_config is None else load_config
        load_config["dataset"] = "3d_front"
