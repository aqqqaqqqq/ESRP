...
def place_base_pose_rearrange(obj, pos, quat=None, z_offset=None):
    """
...
def land_object_rearrange(obj, pos, quat=None, z_offset=None):
    """
    ...
    place_base_pose_rearrange(obj, pos, quat, z_offset)
