...
# gm.ThreeD_FRONT_DATASET_PATH = "/home/pilab/Siqi/github/OmniGibson-Rearrange/omnigibson/data/3d_front"
gm.ThreeD_FRONT_DATASET_PATH = determine_gm_path(os.path.join("data", "3d_front"), "THREEDFRONT_DATASET_PATH")
# gm.SCENES_JSOM_PATH = determine_gm_path(os.path.join("data", "3d_front", "scenes"), "SCENES_JSOM_PATH")
