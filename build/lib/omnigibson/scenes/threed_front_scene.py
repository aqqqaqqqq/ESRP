...
class Threed_FRONTScene(TraversableScene):
    """
    ...
    def __init__(
        ...
        self.scene_dir = scene_type_path
    ...
    def get_scene_loading_info(self, scene_model, scene_instance=None):
        ...
        # fname = "{}_target.json".format(scene_model) if scene_instance is None else scene_instance
        return os.path.join(self.scene_dir, scene_model)
