...
def main(random_selection=False, headless=True, short_exec=False):
    ...
    for ep in range(total_episodes):
        ...
        with open("C:/Users/Admin/Desktop/OmniGibson-Rearrange/evaluate_mobilev3_no_lstm_train.txt", 'a') as f:
...
#     with open("C:/Users/Admin/Desktop/OmniGibson-Rearrange/evaluate_mobilev3_accel.txt", 'r') as f:
#         for line in f:
#             parts = line.split(':', 1)
#             if len(parts[0]) > 0:
